  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden" style={{ background: 'radial-gradient(ellipse at top, #1a1030 0%, #0a0a14 70%)' }}>
      ...
      <div className="flex-1 overflow-y-auto px-6 max-w-lg mx-auto w-full relative z-10">
        <div className="compactable-stack flex flex-col items-center gap-5 py-4">
          ...
          {isNew && (
            <div className="compactable-panel w-full rounded-2xl p-4 border border-yellow-700/40 bg-yellow-900/10 text-center">
          ...
          <div className="compactable-panel w-full rounded-2xl p-5 text-center border border-purple-800/40 relative" style={{ background: 'linear-gradient(160deg, rgba(168,85,247,0.12), rgba(0,0,0,0.2))' }}>
          ...
          <button onClick={() => navigate('news')}
            className="compactable-panel relative w-full rounded-2xl p-3 border border-sky-700/40 bg-sky-900/10 flex items-center gap-2.5 active:scale-95 transition-all hover:bg-sky-900/20">
          ...
          <div className="w-full grid grid-cols-2 gap-3">
            <div className="compactable-panel rounded-2xl p-3 border border-orange-700/40 bg-orange-900/10 flex items-center gap-2.5">
              <span className="text-2xl">🔥</span>
            ...
            <button onClick={() => navigate('progression')} className="compactable-panel relative rounded-2xl p-3 border border-yellow-700/40 bg-yellow-900/10 flex items-center gap-2.5 active:scale-95 transition-all hover:bg-yellow-900/20">
              <span className="text-2xl">🏅</span>
          ...
          {quests.length > 0 && (
            <div className="compactable-panel w-full rounded-2xl p-4 border border-game-border bg-game-surface/70">
...
function Stat({ label, value }) {
  return (
    <div className="compactable-panel rounded-xl p-2 bg-black/30 border border-white/5 text-center">
