export const FR_NAMES = {
  ...
  132: 'Métamorph',
  133: 'Évoli',
  134: 'Aquali', 135: 'Voltali', 136: 'Pyroli',
  137: 'Porygon',
...
export function frName(id, fallback = '') {
  return FR_NAMES[id] || fallback
}
