// Per-Pokémon signature move. Each instance has exactly one move, typed after
// its primary type, whose level can be raised at TM events for more power.
// Names are generic/original (not the official move list).
...
// Battle power of a move at its current level.
...
export function canUpgradeMove(move) {
  return move && move.level < MOVE_MAX_LEVEL;
}
